            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal mt-3"method="POST" action="{{ route('login-email') }}">
                            @csrf
                            ...
                            {{-- adding log in wtih email button --}}
                            <div class="form-group mb-3 text-center row mt-3 pt-1">
                                <div class="col-12">
                                    <a href="{{ route('login') }}"
                                        class="btn btn-info w-100 waves-effect waves-light">Log
                                        In With Username </a>
                                </div>
                            </div>
